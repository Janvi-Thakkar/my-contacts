...
const SignInPage = (props) => {
	...
	return (
		...
		<div className="signin_container" id="container">
				{(windowSize.width > 600 || !showSignIn) && <><div className="form-container sign-up-container">
					<form >
				...
				{(windowSize.width > 600 || showSignIn) && <><div className="form-container sign-in-container">
				<form action="#">
						<h1>Sign In</h1>
				...
				{windowSize.width > 600 && <> <div className="overlay-container">
